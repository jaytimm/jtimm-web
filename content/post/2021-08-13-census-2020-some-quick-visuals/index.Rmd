---
title: 'census 2020: some quick visuals'
author: ''
date: '2021-08-13'
...
A quick/simple post demonstrating how to access Census 2020 counts using the [PL94171](https://github.com/CoryMcCartan/PL94171) package.  Census data won't be API-accessible until ~late September; however, these data are available for redistricting purposes, albeit in a funky format.  The `PL94171` package downloads, re-structures, and tidies these files for super convenient use.
