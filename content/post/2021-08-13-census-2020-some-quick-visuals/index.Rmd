...
> A quick/simple post: using the [PL94171](https://github.com/CoryMcCartan/PL94171) package to access Census 2020 counts.  Census data won't be API-accessible until ~late September; these data are available, however, for redistricting purposes -- albeit in a funky format.  The `PL94171` package can be used to download and re-structure these files for super convenient use. (!)  Some quick visualizations of demographic change in the state of New Mexico.
